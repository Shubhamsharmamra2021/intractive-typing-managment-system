...
<html class="no-js" lang="en">
    <head>
        ...
        <title>My Practice Texts Bigner hindi Mangal - Gayatricomputers</title>
...
<div id="sidebar-md-lg" class="sidebar col-md-12 col-lg-2 visible-md visible-lg "  style="background-color:#DC143C;">
    ...
    <div class="list-group" style="font-size:15px;">
        ...
        <a href="bhindim.php" class="list-group-item active"  >&nbsp;<i class="fa fa-signal"></i>&nbsp; <strong>Beginner in Hindi (Mangal)</strong></br><small>Take a Test</small> </a>
...
$selectquery="select * from  typingtest where language=6 order by id ASC LIMIT $start_from, $limit  ";
...
?>
                            	<tr onclick="location.href='htype.php?id=<?php echo $res["id"]; ?>&title=<?php echo $res["title"]; ?>'">
									...
									<td class="title" colspan="2">
										<a style="font-family: hindi;" href="htype.php?id=<?php echo $res['id']; ?>"><?php echo $res['title']; ?></a> 
...
$result_db = mysqli_query($con,"SELECT COUNT(id) FROM typingtest where language=6"); 
$row_db = mysqli_fetch_row($result_db);  
$total_records = $row_db[0];  
$total_pages = ceil($total_records / $limit); 
/* echo  $total_pages; */
$pagLink = "<ul class='pagination'>
<li class='page-item'><a class='page-link' href='bhindim.php'>«</a></li>";  
for ($i=1; $i<=$total_pages; $i++) {
	$pagLink .= "<li class='page-item'><a class='page-link' href='bhindim.php?page=".$i."'>".$i."</a></li>";	
}
echo $pagLink . "</ul>";  
?>
