...
<html class="no-js" lang="en">
    <head>
        ...
        <title>My Practice Texts - Bigner hindi police</title>
...
<div id="sidebar-md-lg" class="sidebar col-md-12 col-lg-2 visible-md visible-lg "  style="background-color:#DC143C;">
    ...
    <div class="list-group" style="font-size:15px;">
        ...
        <a href="bhindip.php" class="list-group-itemactive "  >&nbsp;<i style="margin-left:2px; margin-right:3px;" class="fa fa-file-text-o"></i>&nbsp; <strong>Beginner in Hindi (police)</strong></br><small>Take a Test</small> </a>
     </div>
...
$selectquery="select * from  typingtest where language=8 order by id ASC LIMIT $start_from, $limit  ";
...
?>
                            	<tr onclick="location.href='htype.php?id=<?php echo $res["id"]; ?>&title=<?php echo $res["title"]; ?>'">
									...
									<td class="age">Today<br><small class="text-muted">03:14</small></td>
								</tr> 									
<?php } 
}    ?>									
...
$result_db = mysqli_query($con,"SELECT COUNT(id) FROM typingtest where language=8"); 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' href='hindiindex.php'>«</a></li><li class='page-item'><a class='page-link' href='hindiindex.php?page=".$i."'>".$i."</a></li>";	
}
echo $pagLink . "</ul>";  
?>
