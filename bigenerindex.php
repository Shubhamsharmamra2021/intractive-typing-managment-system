...
<html class="no-js" lang="en">
    <head>
        ...
        <title>My Practice Texts for English bigener- Gayatricomputers</title>
...
<div id="sidebar-md-lg" class="sidebar col-md-12 col-lg-2 visible-md visible-lg "  style="background-color:#DC143C;">
    ...
    <div class="list-group" style="font-size:15px;">
        ...
        <a href="bigenerindex.php" class="list-group-item active"  >&nbsp;<i style="margin-left:2px; margin-right:3px;" class="fa fa-file-text-o"></i>&nbsp; <strong>Beginner in English (English)</strong></br><small>Take a Test</small> </a>
...
<div class="row main-layout" id="text-practice"  >
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="main-content"  style="background:none;">
		...
		<ul class="nav nav-tabs" id="practice-mode-selection-menu" style="font-size: 1.2em; margin-top: 0px; margin-left:0px">
			...
			<li class="active" style="padding-left: 0px;"><a href="benglish.php"> ENGLISH TYPING</a></li>
			<li class="" style="padding-left: 0px;"><a href="hindikindex.php"> Hindi ( kurtidev )</a></li>
			<li class="" style="padding-left: 0px;"><a href="hindipindex.php"> Hindi ( police )</a></li>
...
$selectquery="select * from  typingtest where language=5 order by id ASC LIMIT $start_from, $limit  ";
...
?>
								<tr onclick="location.href='type.php?id=<?php echo $res["id"]; ?>&title=<?php echo $res["title"]; ?> '">	
									...
									<td class="title" colspan="2">
										<a href="type.php?id=<?php echo $res['id']; ?>&title=<?php echo $res['title']; ?>"><?php echo $res['title']; ?></a> 
...
$result_db = mysqli_query($con,"SELECT COUNT(id) FROM typingtest where language=3"); 
$row_db = mysqli_fetch_row($result_db);  
$total_records = $row_db[0];  
$total_pages = ceil($total_records / $limit); 
/* echo  $total_pages; */
$pagLink = "<ul class='pagination'>
<li class='page-item'><a class='page-link' href='bigenerindex.php'>«</a></li>";  
for ($i=1; $i<=$total_pages; $i++) {
	$pagLink .= "<li class='page-item'><a class='page-link' href='bigenerindex.php?page=".$i."'>".$i."</a></li>";	
}
echo $pagLink . "</ul>";  
?>
