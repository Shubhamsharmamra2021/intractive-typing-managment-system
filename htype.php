			        ...
			        <div class="tab-pane active" id="text-practice-content">	
	                    <div class="row" style="padding-top:1em;">
                   	        <div class="col-md-8 col-sm-12 col-xs-12">
									  <h2 id="view-title" style=" text-transform: uppercase;"><?php echo  $row['title'];  ?> </h2>
									  </br>
                   	        	<p class="text-muted">
                                    <small>created time:<?php echo date("H:i", strtotime($row['dates']));?> Date:<?php echo date("d.m.Y", strtotime($row['dates']));?> <a href="user-id"><a href="tindex.php">ShubhamSharma7</a></a></small>
                   	         	</p>
							</div>
							   </br>
	                        <div class="col-md-4 col-sm-12 col-xs-12 unselectable" unselectable="yes" onselectstart="return false;" >
                                ...
                                <div class="pull-right" style="text-align: right; border-right: 1px solid #ddd; padding-right: 10px;">
                                    <div style="margin-bottom: 2px;"><span style="text-transform:uppercase;font-size:1.2em;font-weight:bold;"><?php  $word= substr_count("$shubh"," "); echo $word;?></span><span style="text-transform:uppercase;font-size:.8em">words</span></div>
                        	...
                        	<div class="col-md-12">
                        		<div class="tdiff">
                                    ...
                                    <div id="timerPreview">
                                        ...
                                        <strong style="   ">
                                        	<p id="testPreview"   style=" line-height: 25.8px;  background-color:#F8F8F8; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;,  font-weight:600;     border:2px solid black; padding-left:10px; padding-top:10px; padding-botton:10px; font-size:23px;   ">
