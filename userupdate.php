...
include ('connection.php'); 
	...
	{               
 	...
 	//updating the table
 $swl = mysqli_query($con, "UPDATE usertest SET title='$title' , text='$text' , language='$langu' , converttext = '$context' , words = '$words' , characters =  '$char' WHERE id=$id");
...
$result = mysqli_query($con, "SELECT * FROM usertest WHERE id=$id");
    	...
    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="main-content" style="background:none;">
    		...
    		<div class="tab-content" style="min-height: 400px; border: 1px solid #ddd; border-top: none; background:white; padding: 20px; padding-top:5px;">
    			...
    			<div class="tab-pane active" id="text-practice-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">			    						
                        		<form method="post" action="userupdate.php?id=<?php  echo $res['id']; ?>" class="form-horizontal" role="form" >
