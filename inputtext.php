    	...
    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="main-content" style="background:none;">
    		...
    		<div class="tab-content" style="min-height: 400px; border: 1px solid #ddd; border-top: none; background:white; padding: 20px; padding-top:5px;">
    			...
    			<div class="tab-pane active" id="text-practice-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                    		<form action="inputtext.php" class="form-horizontal" role="form" id="TextAddForm" method="post" accept-charset="utf-8">
                    		    ...
                    		    <div class="form-group">
                    		    	...
                    		    	<div class="col-sm-10">
                    		    		<select name="datalan" class="form-control" id="TextSpeedtestId">
											...
											<option value="5" >Beginner English (English)</option>
                    		    			<option value="6" >Beginner Hindi (Mangal)</option>
											<option value="7" >Beginner Hindi (kurtidev)</option>
                    		    			<option value="8" >Beginner Hindi (police)</option>
...
include ('connection.php');
    if(isset($_POST['submit'])){
					...
					$insertquery="insert into typingtest( `title`, `text`, `language`, `converttext`, `words`, `characters`)
					 values ( '$title', '$text', '$langu', '$context', '$words', '$char' )";
