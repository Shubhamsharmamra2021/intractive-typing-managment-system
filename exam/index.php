...
function validateForm() {var y = document.forms["form"]["name"].value;
  ...
  return false;}var z =document.forms["form"]["college"].value;
...
var dotpos = x.lastIndexOf(".");if (atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length)
 {alert("Not a valid e-mail address.");return false;}var a = document.forms["form"]["password"].value;
 if(a == null || a == ""){alert("Password must be filled out");
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Gayatri Computer Classes</span></div>
...
<!-- sign in form begins -->  
  <form class="form-horizontal" name="form" action="sign.php?q=loginstudent.php" onSubmit="return validateForm()" method="POST">
<fieldset>
