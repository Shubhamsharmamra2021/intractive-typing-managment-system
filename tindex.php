...
<html class="no-js" lang="en">
    <head>
        ...
        <title>My Practice Texts for all - Gayatricomputers</title>
...
<div id="sidebar-md-lg" class="sidebar col-md-3 col-lg-2 visible-md visible-lg "  style="background-color:#DC143C;">
...
<div class="row main-layout" id="text-practice"  >
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="main-content"  style="background:none;">
		...
		<ul class="nav nav-tabs" id="practice-mode-selection-menu" style="font-size: 1.2em; margin-top: 0px; margin-left:0px">
			...
			<li class="active"><a href="tindex.php" style="padding-left: 20px; padding-right: 20px; margin-right: 40px;">TYPING-TEST</a></li>
			...
			<li class="" style="padding-left: 0px;"><a href="hindikindex.php"><span class="glyphicon glyphicon-edit"></span>Hindi ( kurtidev )</a></li>
 			<li class="" style="padding-left: 0px;"><a href="usertypingtext.php"><span class="glyphicon glyphicon-edit"></span>MYTypingText</a></li>
