...
<html class="no-js" lang="en">
    <head>
        ...
        <title>My Practice Texts  hindi Kurtidev - Gayatricomputers</title>
...
<div id="sidebar-md-lg" class="sidebar col-md-12 col-lg-2 visible-md visible-lg "  style="background-color:#DC143C;">
    ...
    <div class="list-group" style="font-size:15px;">
		...
		<a href="hindikindex.php" class="list-group-item active"  >&nbsp;<i class="fa fa-users"></i>&nbsp; <strong>Hindi (kurtidev)</strong></br><small>Take a Test</small> </a>
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="main-content"  style="background:none;">
		...
		<ul class="nav nav-tabs" id="practice-mode-selection-menu" style="font-size: 1.2em; margin-top: 0px; margin-left:0px">
 		<li class=""><a href="hindiindex.php"><span class="glyphicon glyphicon-fire"></span> HINDI (MANGAL)</a></li>
			...
			<li class="active" style="padding-left: 0px;"><a href="hindikindex.php"><span class="glyphicon glyphicon-edit"></span>Hindi ( kurtidev )</a></li>
...
$selectquery="select * from  typingtest where language=3 order by id DESC LIMIT $start_from, $limit  ";
...
$result_db = mysqli_query($con,"SELECT COUNT(id) FROM typingtest where language=4"); 
$row_db = mysqli_fetch_row($result_db);  
$total_records = $row_db[0];  
$total_pages = ceil($total_records / $limit); 
/* echo  $total_pages; */
$pagLink = "<ul class='pagination'>
<li class='page-item'><a class='page-link' href='hindikindex.php'>«</a></li>";  
for ($i=1; $i<=$total_pages; $i++) {
	$pagLink .= "<li class='page-item'><a class='page-link' href='hindikindex.php?page=".$i."'>".$i."</a></li>";	
}
echo $pagLink . "</ul>";  
?>
