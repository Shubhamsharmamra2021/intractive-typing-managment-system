...
<html class="no-js" lang="en">
    <head>
        ...
        <title>My Practice Texts hindi Mangal - Gayatricomputers</title>
...
<div id="sidebar-md-lg" class="sidebar col-md-12 col-lg-2 visible-md visible-lg "  style="background-color:#DC143C;">
    ...
    <div class="list-group" style="font-size:15px;">
			...
			<a href="tindex.php" class="list-group-item  " >&nbsp;<i class="fa fa-play"></i>&nbsp; <strong>All languages</strong></br><small>Take a Test</small>  </a>
		...
		<a href="hindiindex.php" class="list-group-item active"  >&nbsp;<i class="fa fa-cogs"></i>&nbsp; <strong>Hindi (Mangal)</strong></br><small>Take a Test</small> </a>
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="main-content"  style="background:none;">
		<div class="row" style="padding-bottom: 2px; border-bottom: 1px solid http://gcc.shivanjprogramming.tech/eee;">
			...
			<div class="col-md-4 col-sm-12">
									<div style="margin-top:7px;" class="pull-left">Language filter:</div>
					<div style="margin-left: 10px;" class="pull-left">
						<select class="form-control" id="changeTextLanguageSelection" style="margin-bottom: 3px;">
		...
		<ul class="nav nav-tabs" id="practice-mode-selection-menu" style="font-size: 1.2em; margin-top: 0px; margin-left:0px">
 		 		<li class="active"><a href="hindiindex.php"><span class="glyphicon glyphicon-fire"></span> HINDI (MANGAL)</a></li>
			<li class=" "><a href="tindex.php" style="padding-left: 20px; padding-right: 20px; margin-right: 40px;">TYPING-TEST</a></li>
			<li class="" style="padding-left: 0px;"><a href="benglish.php"><span class="glyphicon glyphicon-edit"></span>ENGLISH TYPING</a></li>
			<li class="" style="padding-left: 0px;"><a href="hindikindex.php"><span class="glyphicon glyphicon-edit"></span>Hindi ( kurtidev )</a></li>
			<li class="" style="padding-left: 0px;"><a href="hindipindex.php"><span class="glyphicon glyphicon-edit"></span>Hindi ( police )</a></li>
	...
	<div class="table-responsive" id="sortable-table-wrap">
		...
		<thead>
				<tr>
					...
					<th class="sort col-md-4" data-sort="title"><a href="#">Title</a></th>
					<th class="col-md-2">
...
$selectquery="select * from  typingtest where language=2 order by id DESC LIMIT $start_from, $limit  ";
...
?>
                            	<tr onclick="location.href='htype.php?id=<?php echo $res["id"]; ?>&title=<?php echo $res["title"]; ?>'">
									...
									<td class="title" colspan="2">
										<a style="font-family: hindi;" href="htype.php?id=<?php echo $res['id']; ?>&title=<?php echo $res['title']; ?>"><?php echo $res['title']; ?></a> 
										<br><small style="font-family: hindi;" class="text-muted">&quot;<?php $desc = $res['text'] ;
...
<td class="age">Time:<?php echo date("H:i", strtotime($res['dates']));?><br><small class="text-muted">Date:<?php echo date("d.m.Y", strtotime($res['dates']));?></small></td>								</tr> 									
<?php } 
}    ?>									
	...
	</div> <!-- // id=sortable-table-wrap -->
	<?php  

$result_db = mysqli_query($con,"SELECT COUNT(id) FROM typingtest where language=2"); 
$row_db = mysqli_fetch_row($result_db);  
$total_records = $row_db[0];  
$total_pages = ceil($total_records / $limit); 
/* echo  $total_pages; */
$pagLink = "<ul class='pagination'>
<li class='page-item'><a class='page-link' href='hindiindex.php'>«</a></li>";  
for ($i=1; $i<=$total_pages; $i++) {
	$pagLink .= "<li class='page-item'><a class='page-link' href='hindiindex.php?page=".$i."'>".$i."</a></li>";	
}
echo $pagLink . "</ul>";  
?>
...
<?php include 'footer.php';?>        
	...
	<script type="text/javascript" src="/js/globalfunctions.min.js?1607848514"></script>
		<script type="text/javascript">
//<![CDATA[
$(document).ready(function () {

		$(function() {
			$("selecthttp://gcc.shivanjprogramming.tech/changeTextLanguageSelection").on('change', function() {
            	window.location.replace("https://gcccomputers/text-practice/change-language/"+$(this).val());
        	});
		});
		...
		$(function() {
			...
			setInterval(function() {
				var count = $("http://gcc.shivanjprogramming.tech/activity-module div.list-group-item").size();
				//console.log(count);
				if(count > 5)
					$("http://gcc.shivanjprogramming.tech/activity-module http://gcc.shivanjprogramming.tech/children div.list-group-item:last").hide().remove();
