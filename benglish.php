...
<html class="no-js" lang="en">
    <head>
        ...
        <title>My Practice Texts Only english - Gayatricomputers</title>
...
<div id="sidebar-md-lg" class="sidebar col-md-12 col-lg-2 visible-md visible-lg "  style="background-color:#DC143C;">
    ...
    <div class="list-group" style="font-size:15px;">
        ...
        <a href="benglish.php" class="list-group-item active"  >&nbsp;<i class="fa fa-forward"></i>&nbsp; <strong>English (English)</strong></br><small>Take a Test</small>  </a>
...
$selectquery="select * from  typingtest where language=1 order by id DESC LIMIT $start_from, $limit  ";
...
$result_db = mysqli_query($con,"SELECT COUNT(id) FROM typingtest where language=1"); 
$row_db = mysqli_fetch_row($result_db);  
$total_records = $row_db[0];  
$total_pages = ceil($total_records / $limit); 
/* echo  $total_pages; */
$pagLink = "<ul class='pagination'>
<li class='page-item'><a class='page-link' href='benglish.php'>«</a></li>";  
for ($i=1; $i<=$total_pages; $i++) {
	$pagLink .= "<li class='page-item'><a class='page-link' href='benglish.php?page=".$i."'>".$i."</a></li>";	
}
echo $pagLink . "</ul>";  
?>
